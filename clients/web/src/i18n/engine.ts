...
export const SUPPORTED_LOCALES = [
  'en', 'es', 'pt', 'fr', 'de', 'it', 'nl', 'pl', 'el', 'uk', 'ru', 'tr',
  'sv', 'da', 'nb', 'fi', 'ar', 'fa', 'sw', 'hi', 'id', 'th', 'vi', 'zh',
  'ja', 'ko',
] as const;
...
export const LOCALE_NAMES: Record<Locale, string> = {
  ...
  el: 'Ελληνικά', uk: 'Українська', ru: 'Русский', tr: 'Türkçe',
  sv: 'Svenska', da: 'Dansk', nb: 'Norsk', fi: 'Suomi',
  ar: 'العربية', fa: 'فارسی', sw: 'Kiswahili', hi: 'हिन्दी',
  id: 'Bahasa Indonesia', th: 'ไทย', vi: 'Tiếng Việt', zh: '中文',
  ja: '日本語', ko: '한국어',
};
