...
export const el: Catalog = {
  ...
  upgrade_card_note:
    'Ανανεώνεται αυτόματα· ακύρωσε όποτε θέλεις από το email απόδειξης της Stripe. Η πληρωμή σε FLUX παραπάνω είναι φθηνότερη — η τιμή με κάρτα καλύπτει τα έξοδα επεξεργασίας.',
