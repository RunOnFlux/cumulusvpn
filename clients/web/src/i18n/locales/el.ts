...
export const el: Catalog = {
  ...
  otherdev_eyebrow: 'Πληρώνεις για άλλη συσκευή;',
  otherdev_lede:
    'Το premium συνδέεται με το κλειδί μίας συσκευής. Για να πληρώσεις από εδώ για το τηλέφωνό σου, άνοιξε την εφαρμογή → Ρυθμίσεις → Σχετικά και αντίγραψε τον κωδικό συσκευής.',
  otherdev_placeholder: 'Κωδικός συσκευής',
  otherdev_apply: 'Χρήση αυτού του κωδικού',
  otherdev_active:
    'Έλεγξε ότι ταιριάζει με τον κωδικό που δείχνει εκείνη η συσκευή — ένας λάθος πληκτρολογημένος κωδικός μπορεί να είναι έγκυρος και να πληρώσει τη λάθος συσκευή.',
  otherdev_clear: 'Επιστροφή σε αυτό το πρόγραμμα περιήγησης ({code}…)',
  otherdev_err:
    'Αυτός δεν είναι έγκυρος κωδικός συσκευής. Αντίγραψέ τον από Ρυθμίσεις → Σχετικά στη συσκευή που θες να αναβαθμίσεις.',
