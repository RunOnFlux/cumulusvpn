...
export const ru: Catalog = {
  ...
  upgrade_card_note:
    'Продлевается автоматически; отменить можно в любой момент из письма-квитанции Stripe. Платить в FLUX выше дешевле — цена при оплате картой включает комиссию за обработку.',
