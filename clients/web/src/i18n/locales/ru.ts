...
export const ru: Catalog = {
  ...
  otherdev_eyebrow: 'Платишь за другое устройство?',
  otherdev_lede:
    'Premium привязан к ключу одного устройства. Чтобы оплатить отсюда свой телефон, открой приложение → Настройки → О приложении и скопируй код устройства.',
  otherdev_placeholder: 'Код устройства',
  otherdev_apply: 'Использовать этот код',
  otherdev_active:
    'Проверь, что он совпадает с кодом на том устройстве — код с опечаткой может остаться валидным и оплатит не то устройство.',
  otherdev_clear: 'Вернуться к этому браузеру ({code}…)',
  otherdev_err:
    'Это недействительный код устройства. Скопируй его в Настройки → О приложении на устройстве, которое хочешь обновить.',
