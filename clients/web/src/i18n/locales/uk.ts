...
export const uk: Catalog = {
  ...
  upgrade_card_note:
    'Поновлюється автоматично; скасуй або зміни план будь-коли в розділі «Твоя підписка» нижче чи з листа-квитанції Stripe. Оплата у FLUX вище дешевша — ціна карткою покриває комісії за обробку.',
  ...
  otherdev_eyebrow: 'Платиш за інший пристрій?',
  otherdev_lede:
    'Premium прив’язаний до ключа одного пристрою. Щоб оплатити звідси свій телефон, відкрий застосунок → Налаштування → Про застосунок і скопіюй код пристрою.',
  otherdev_placeholder: 'Код пристрою',
  otherdev_apply: 'Використати цей код',
  otherdev_active:
    'Перевір, що він збігається з кодом на тому пристрої — помилково набраний код може лишитися дійсним і оплатить не той пристрій.',
  otherdev_clear: 'Повернутися до цього браузера ({code}…)',
  otherdev_err:
    'Це недійсний код пристрою. Скопіюй його в Налаштування → Про застосунок на пристрої, який хочеш оновити.',

  manage_eyebrow: 'Твоя підписка',
  manage_lede:
    'Зміни картку, переключися між місячним і річним планом або скасуй. Відкриває захищений платіжний портал Stripe.',
  manage_none:
    'У цьому браузері підписку карткою не купували. Якщо ти оформив її на іншому пристрої, скористайся посиланням у листі-квитанції Stripe — або App Store / Google Play, якщо підписку оформлено в застосунку.',
  manage_cta: 'Керувати підпискою',
  manage_cta_busy: 'Відкриваємо платіжний портал…',
  manage_err:
    'Не вдалося відкрити платіжний портал у цьому браузері. Ти завжди можеш керувати підпискою або скасувати її за посиланням у листі-квитанції від Stripe.',
