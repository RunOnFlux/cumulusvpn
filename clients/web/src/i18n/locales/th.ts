...
export const th: Catalog = {
  ...
  upgrade_card_note:
    'ต่ออายุอัตโนมัติ ยกเลิกหรือเปลี่ยนแพ็กเกจได้ทุกเมื่อที่ “การสมัครสมาชิกของคุณ” ด้านล่าง หรือจากอีเมลใบเสร็จของ Stripe การจ่ายด้วย FLUX ด้านบนถูกกว่า — ราคาบัตรรวมค่าธรรมเนียมการประมวลผลแล้ว',
  ...
  otherdev_eyebrow: 'กำลังจ่ายให้อุปกรณ์อื่นอยู่ใช่ไหม',
  otherdev_lede:
    'พรีเมียมผูกกับคีย์ของอุปกรณ์เครื่องเดียว หากต้องการจ่ายให้โทรศัพท์ของคุณจากที่นี่ ให้เปิดแอป → การตั้งค่า → เกี่ยวกับ แล้วคัดลอกรหัสอุปกรณ์',
  otherdev_placeholder: 'รหัสอุปกรณ์',
  otherdev_apply: 'ใช้รหัสนี้',
  otherdev_active:
    'ตรวจสอบว่าตรงกับรหัสที่แสดงบนอุปกรณ์นั้น — รหัสที่พิมพ์ผิดอาจยังใช้ได้และจะไปจ่ายให้อุปกรณ์ผิดเครื่อง',
  otherdev_clear: 'กลับไปใช้เบราว์เซอร์นี้ ({code}…)',
  otherdev_err:
    'นี่ไม่ใช่รหัสอุปกรณ์ที่ถูกต้อง คัดลอกจาก การตั้งค่า → เกี่ยวกับ บนอุปกรณ์ที่คุณต้องการอัปเกรด',

  manage_eyebrow: 'การสมัครสมาชิกของคุณ',
  manage_lede:
    'อัปเดตบัตร สลับระหว่างรายเดือนกับรายปี หรือยกเลิก จะเปิดพอร์ทัลการเรียกเก็บเงินที่ปลอดภัยของ Stripe',
  manage_none:
    'ไม่มีการสมัครสมาชิกด้วยบัตรในเบราว์เซอร์นี้ หากคุณสมัครจากอุปกรณ์อื่น ให้ใช้ลิงก์ในอีเมลใบเสร็จของ Stripe หรือ App Store / Google Play หากสมัครในแอป',
  manage_cta: 'จัดการการสมัครสมาชิก',
  manage_cta_busy: 'กำลังเปิดพอร์ทัลการเรียกเก็บเงิน…',
  manage_err:
    'ไม่สามารถเปิดพอร์ทัลการเรียกเก็บเงินจากเบราว์เซอร์นี้ได้ คุณสามารถจัดการหรือยกเลิกได้เสมอจากลิงก์ในอีเมลใบเสร็จของ Stripe',
