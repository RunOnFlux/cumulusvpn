...
export const fa: Catalog = {
  ...
  upgrade_card_note:
    'به‌صورت خودکار تمدید می‌شود؛ هر زمان خواستید از ایمیل رسید Stripe لغو کنید. پرداخت با FLUX در بالا ارزان‌تر است — قیمت کارت هزینه‌های پردازش را پوشش می‌دهد.',
