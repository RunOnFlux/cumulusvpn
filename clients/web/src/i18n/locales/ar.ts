...
export const ar: Catalog = {
  ...
  connect_verify_warn:
    'تعذّر التحقق من توقيع الدليل — تُعرض نقاط النهاية للعِلم فقط.',
  ...
  connect_identity_note:
    'يُسجَّل زوج مفاتيح واحد لكل جهاز في بوابات عديدة؛ تتبع الترقية المفتاح في جميعها عبر السلسلة. رمز الدفع أدناه هو ما يربط دفعة FLUX بهذا المفتاح.',
  ...
  multihop_style_cross:
    'نمط المسار: أقصى خصوصية — عبر الولايات القضائية (مشغّلان، دولتان)',
