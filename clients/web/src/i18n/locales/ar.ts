...
export const ar: Catalog = {
  ...
  otherdev_eyebrow: 'هل تدفع لجهاز آخر؟',
  otherdev_lede:
    'الاشتراك المميز مرتبط بمفتاح جهاز واحد. للدفع لهاتفك من هنا، افتح التطبيق ← الإعدادات ← حول وانسخ رمز الجهاز.',
  otherdev_placeholder: 'رمز الجهاز',
  otherdev_apply: 'استخدام هذا الرمز',
  otherdev_active:
    'تأكد أنه يطابق الرمز الظاهر على ذلك الجهاز — فالرمز المكتوب خطأً قد يظل صالحًا ويدفع لجهاز آخر.',
  otherdev_clear: 'العودة إلى هذا المتصفح ({code}…)',
  otherdev_err: 'هذا ليس رمز جهاز صالحًا. انسخه من الإعدادات ← حول على الجهاز الذي تريد ترقيته.',
