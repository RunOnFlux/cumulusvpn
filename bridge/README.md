...
| `STRIPE_TEST_GRANTS`                         | Whether TEST-mode invoices settle on chain — **keep false**                       | Not set. With `sk_test_`, one 4242 checkout would otherwise broadcast a real 20-FLUX tx; test invoices stay verified and bound, just unsettled (same stance as the Apple/Google sandbox flags)                                                                                                                |
